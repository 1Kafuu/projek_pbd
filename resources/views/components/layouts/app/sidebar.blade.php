        ...
        <nav class="bg-gray-800">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="{{ route('datauser') }}"
                                    class="{{request()->is('datauser') ? 'bg-gray-950/50  text-white' : ' text-gray-300 hover:bg-white/5 hover:text-white'}} rounded-md px-3 py-2 text-sm font-medium">Data
                                    User</a>
                                <a href="{{ route('datarole') }}"
                                    class="{{request()->is('datarole') ? 'bg-gray-950/50  text-white' : ' text-gray-300 hover:bg-white/5 hover:text-white'}} rounded-md px-3 py-2 text-sm font-medium">Data
                                    Role</a>
                                <a href="{{ route('datavendor') }}"
                                    class="{{request()->is('datavendor') ? 'bg-gray-950/50  text-white' : ' text-gray-300 hover:bg-white/5 hover:text-white'}} rounded-md px-3 py-2 text-sm font-medium">Data
                                    Vendor</a>
                                <a href="{{ route('databarang') }}"
                                    class="{{request()->is('databarang') ? 'bg-gray-950/50  text-white' : ' text-gray-300 hover:bg-white/5 hover:text-white'}} rounded-md px-3 py-2 text-sm font-medium">Data
                                    Barang</a>
                                <a href="{{ route('datasatuan') }}"
                                    class="{{request()->is('datasatuan') ? 'bg-gray-950/50  text-white' : ' text-gray-300 hover:bg-white/5 hover:text-white'}} rounded-md px-3 py-2 text-sm font-medium">Data
                                    Satuan</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <el-dropdown class="relative ml-3">
                                ...
                                <el-menu anchor="bottom end" popover
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button
                                            class="block px-4 py-2 pr-30 text-sm text-gray-300 focus:bg-white/5 focus:outline-hidden"
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    ...
                    <a href="#"
                        class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Data
                        User</a>
                    <a href="#"
                        class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Data
                        Role</a>
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            <button type="submit"
                                class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-white/5 hover:text-white">Sign out</button>
                        </form>
                    </div>
                </div>
            </el-disclosure>
