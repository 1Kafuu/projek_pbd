            ...
            <div class="bg-white border border-gray-300 rounded-lg shadow-sm p-6">
                <div
                    ...
                    <div class="mb-4 sm:mb-0">
                        <h3 class="text-2xl font-semibold text-gray-800">Create Margin</h3>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form action="{{ route('store-margin') }}" method="POST">
                    @csrf
                    <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="relative">
                                <input id="persen" type="decimal" name="persen"
